...
export default class ProfileSavedItem extends Component {
  static contextTypes = {
    i18n: object,
    store: object
  };
    ...
    return (
      <div className="col-md-12 col-sm-12 job-list-search">
        ...
        <div className="row">
          ...
          <div className="col-md-3 col-sm-3 font-text-search">
            <h3 className="text-center-pro float-icon-delete">
              <i
                className="fa fa-times-circle icon-delete-pro"
                aria-hidden="true"
              />
            </h3>
            <h3 className="text-center-pro">
              <span> Xóa hồ sơ</span>
            </h3>
          </div>
        </div>
